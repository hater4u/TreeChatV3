...
public class Server {
    private static final int CONFIRMATION_PERIOD = 2000;
    private static final int SUBSTITUTION_PERIOD = 10000;
    ...
    public void start() throws IOException, ClassNotFoundException {
        System.out.println("Node with name: " + name + ", losses: " + lossPercentage + "%");
    ...
    private class ResendConfirmationTimerTask extends TimerTask {
        ...
        public void run() {
            for (int i = 0; i < unconfirmedMessages.size(); ++i) {
                ...
                if (datagramWrapper.getTimesSent() >= 3) {
                    try {
